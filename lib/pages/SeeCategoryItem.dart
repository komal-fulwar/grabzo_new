...
class SeeCategoryItem extends StatefulWidget {
  SeeCategoryItem({this.id});
  final int id;
  @override
  _SeeCategoryItemState createState() => _SeeCategoryItemState(id);
}

class _SeeCategoryItemState extends State<SeeCategoryItem> {
  _SeeCategoryItemState(this._id);
  int _id;
  var _item;
  void initState() {
    super.initState();
